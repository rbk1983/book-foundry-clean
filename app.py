...
# ==================== Page ====================
st.set_page_config(page_title="Book Foundry — Full Recovery", layout="wide")
...
""".strip()
                ...
                final_resp = client.chat.completions.create(
                    model=chat_model, temperature=0.3, messages=msgs, max_tokens=3200
                )
...
- Use specifics, examples, and anecdotes; avoid fluff.
...
""".strip()
    ...
    if ch_state.get("draft"):
        goals = st.text_input("Revision goals (optional)")
...
GOALS (optional): {goals or 'Improve clarity, tighten flow, add concrete examples, maintain voice and length.'}
